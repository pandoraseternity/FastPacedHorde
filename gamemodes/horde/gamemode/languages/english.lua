...
Weapon damage increases Bleeding buildup by 25% of every hit. 

25% less weapon damage.
]]
LANGUAGE["Infusion_Description_Concussive"] = [[
Convert 100% weapon damage into Blunt damage.

Weapon deals only Blunt damage.

Weapon damage increases Stun buildup by 30% of every hit. 
]]
LANGUAGE["Infusion_Description_Septic"] = [[
Convert 100% weapon damage into Poison damage.

Weapon deals only Poison damage.

Weapon damage increases Break buildup by 30% of every hit. 
]]
LANGUAGE["Infusion_Description_Flaming"] = [[
Convert 100% weapon damage into Fire damage.
...
Convert 100% weapon damage into Cold damage.

Weapon deals only Cold damage.

Weapon damage increases Frostbite buildup by 30% of every hit. 
]]
LANGUAGE["Infusion_Description_Galvanizing"] = [[
Convert 100% weapon damage into Lightning damage.

Weapon deals only Lightning damage.

Weapon damage increases Shock buildup by 30% of every hit. 
]]
...
+5 health when you kill an enemy.
]]
...
10% damage increase per 5 Necrosis buildup, up to 25%.

Gain 5 Necrosis buildup per second while holding this weapon.
]]
...
Players near you also gain {1} Adrenaline and 10 Barrier, up to {2} Adrenaline.
...
Grenades, SLAMs and Tripmines spawn {1} mini-nades on detonation.
...
LANGUAGE["Perk_demolition_chain_reaction"] = [[Blast damage causes a linking explosion that increases with damage.
If damage is below 50, then it will not trigger.]]
...
Instantly kills enemies with less than 15% health.]]
...
Remove 25 armor upon melee hit.]]
...
Recover 50 health.
Gain a 5 second 50% speed boost.
]]

LANGUAGE["Gadget_gadget_cortex"] = [[Cortex Stimulator]]
LANGUAGE["Gadget_Desc_gadget_cortex"] = [[
For each enemy near you, gain 1 Adrenaline stack and 35 Barrier.
...
When you have less than 50% health, you gain 1 health per second.
...
Projectile deals 250 Blast damage.
Generates 4 extra explosions after a short delay.
If you are Warlock with Meteorite, deal extra damage depending on level.
]]
...
Give players within your aura 30 armor.
]]
...
Shockwave deals 180 Lightning damage.
]]
...
Where you look at, rapidly generates a series of shockwaves.
