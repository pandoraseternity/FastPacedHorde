...
SPELL.Fire            = function (ply, wpn, charge_stage)
    ...
    local base_damage = math.floor(150 + 12 * math.pow(level, 1.2)) * bonus.more * (1 + bonus.increase)
    local base_damage_2 = math.floor(1000 + 100 * math.pow(level, 1.2)) * bonus.more * (1 + bonus.increase)
    ...
    timer.Simple(3, function ()
        ...
        util.BlastDamageInfo(dmg, pos, 1050)
    local flashorigin = t2:GetPos() 
    local flashpower = 270
