...
att.AbbrevName = "Medic Launcher"
att.Icon = Material("entities/att/acwatt_uc_ubgl_m203.png", "mips smooth")
att.Description = "Single-shot underbarrel grenade launcher designed to replace the Colt XM148. Able to fire medic grenades."
...
local function Ammo(wep)
    return wep:GetOwner():GetAmmoCount("arccw_nade_medic_ubgl")
end
...
att.UBGL_Fire = function(wep, ubgl)
    ...
    if class == "BUCKSHOT" then
        ...
        if SERVER then
            proj.Damage = 210 -- lower than the m79 (200) for balance reasons
        end
...
att.UBGL_Reload = function(wep, ubgl)
    ...
    wep:GetOwner():SetAmmo(reserve - load, "arccw_nade_medic_ubgl")
    wep:SetClip2(load)
end
...
att.ToggleStats = {
    {
        ...
        UBGL_Entity = "arccw_ubgl_medicgrenade"
    },
    {
        PrintName = "Smoke",
