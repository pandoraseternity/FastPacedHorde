-- Enemies
HORDE.enemies = HORDE.enemies || {}
HORDE.bosses = HORDE.bosses || {}
HORDE.enemies_normalized = HORDE.enemies_normalized || {}
HORDE.bosses_normalized = HORDE.bosses_normalized || {}
...
function HORDE:GetDefaultEnemiesData ()
	...
	HORDE:CreateEnemy("Wraith", "npc_vj_horde_wraith",                  	0.4,  3, true, 1, 1, 1.25, 1)
	...
	HORDE:CreateEnemy("Cyst", "npc_vj_horde_cyst",                  		0.6,  4, true, 1, 1, 1, 1)
	...
	HORDE:CreateEnemy("Wraith", "npc_vj_horde_wraith",                  	0.4,  4, true, 1, 1, 1.25, 1)
	...
	HORDE:CreateEnemy("Healer", "npc_vj_horde_healer",                      0.8,  4, false, 1, 1, 1, 1)
	...
	HORDE:CreateEnemy("Cyst", "npc_vj_horde_cyst",                  		0.08,  5, true, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 1.00,  5, false, 1, 1.1, 1, 1)
    HORDE:CreateEnemy("Zombine", "npc_vj_horde_zombine",                    0.75,  5, false, 1, 1.1, 1, 1)
	HORDE:CreateEnemy("Healer", "npc_vj_horde_healer",                      0.8,  5, false, 1, 1, 1, 1)
    ...
    --{is_boss=true, end_wave=true, unlimited_enemies_spawn=false, enemies_spawn_threshold=0.0, music="ocpack/tobehereremix.mp3", music_duration=SoundDuration("ocpack/tobehereremix.mp3")})
	...
	HORDE:CreateEnemy("Cyst", "npc_vj_horde_cyst",                  		0.4,  6, true, 1, 1, 1, 1)
	...
	HORDE:CreateEnemy("Wraith", "npc_vj_horde_wraith",                  	0.4,  6, true, 1, 1, 1.25, 1)
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  6, false, 1, 1, 1, 1)
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 1.00,  6, false, 1, 1, 1.1, 1)
	...
	HORDE:CreateEnemy("Weeper","npc_vj_horde_weeper",                       0.3,  6, true, 1, 1, 1.5, 1, nil,nil,nil,nil,nil,nil,nil,1)
	...
	HORDE:CreateEnemy("Wraith", "npc_vj_horde_wraith",                  	0.5,  7, true, 1, 1, 1.25, 1)
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  7, false, 1, 1, 1, 1)
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 1.00,  7, false, 1, 1, 1.1, 1)
    ...
    HORDE:CreateEnemy("Blight", "npc_vj_horde_blight",                      0.05,  7, true, 1, 1, 1.25, 1)
	...
	HORDE:CreateEnemy("Gonome",      "npc_vj_gonome_remake",                0.75,  7, true, 1, 1, 1, 1)
	--HORDE:CreateEnemy("Gonome Cop",      "npc_vj_gonome_cop",               0.75,  7, true, 1, 1, 1.25, 1)
	...
	HORDE:CreateEnemy("Wraith", "npc_vj_horde_wraith",                  	0.5,  8, true, 1, 1, 1.25, 1)
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 1.00,  8, false, 1, 1, 1.1, 1)
	...
	--HORDE:CreateEnemy("Gonome HECU",      "npc_vj_gonome_zecu",             0.5,  8, true, 1, 1, 1.25, 1)
...
--function HORDE:CreateEnemy(name, class, weight, wave, is_elite, health_scale, damage_scale, reward_scale, model_scale, color, weapon, spawn_limit, boss_properties, mutation, skin, model, spawn_min, gadget_drop)
	...
	HORDE:CreateEnemy("Cyst", "npc_vj_horde_cyst",                  		0.5,  9, true, 1, 1, 1, 1)
	...
	HORDE:CreateEnemy("Wraith", "npc_vj_horde_wraith",                  	0.5,  9, true, 1, 1, 1.25, 1)
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 1.00,  9, false, 1, 1, 1.1, 1)
    --HORDE:CreateEnemy("Zombine", "npc_vj_horde_zombine",                    0.5,  9, false, 1, 1, 1.1, 1)
	...
	HORDE:CreateEnemy("Gonome Armored", "npc_vj_gonomearmor",         		0.4,  9, true, 1, 1, 1.25, 1, nil,nil,nil,nil,"decay",nil,nil)
