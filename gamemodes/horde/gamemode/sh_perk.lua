...
if SERVER then
    ...
    function HORDE:UseQuickGrenade(ply)
        if ply:HasWeapon("horde_carcass") or ply:HasWeapon("horde_astral_relic") or ply:HasWeapon("horde_void_projector") or ply:HasWeapon("horde_solar_seal") or ply:GetActiveWeapon().SpellWeapon == true then return end
        local classes = {
