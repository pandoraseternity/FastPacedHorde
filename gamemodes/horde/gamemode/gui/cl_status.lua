...
hook.Add("HUDPaint", "Horde_DrawHud", function ()
    ...
    if GetConVarNumber("horde_enable_ammo_gui") == 1 then
        ...
        if (MySelf:HasWeapon("horde_carcass") == false) and (MySelf:HasWeapon("horde_astral_relic") == false) and (MySelf:HasWeapon("horde_void_projector") == false) and (MySelf:HasWeapon("horde_solar_seal") == false) and (MySelf:GetActiveWeapon().SpellWeapon == nil) then
