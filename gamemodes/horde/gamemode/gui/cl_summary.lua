...
function PANEL:Init()
    ...
    self.create_diff_panel = function (diff)
        ...
        vote_btn:Dock(TOP)
        vote_btn:SetText("")
		vote_btn.DoDoubleClick = function ()
			local diff_doubleclick = vgui.Create("DLabel", vote_btn)
			diff_doubleclick:Dock(LEFT)
			diff_doubleclick:SetText("")
			diff_doubleclick:SetSize(80, 80)
			diff_doubleclick:SetColor(Color(255,255,255))
			diff_doubleclick:SetFont("Content")
			diff_doubleclick.Paint = function ()
                draw.SimpleText("asdfasdd", "Content", 10, 20, HORDE.color_crimson, TEXT_ALIGN_LEFT)
			end
			timer.Simple(4, function ()
					diff_doubleclick:Remove()
			end)
