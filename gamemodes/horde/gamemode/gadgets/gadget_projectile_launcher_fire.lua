GADGET.PrintName = "Projectile Launcher (Fire)"
GADGET.Description = "Shoots a flaming projectile.\nIgnites all enemies caught in the explosion.\nDeals 20 + 180 base Ignite damage."
GADGET.Icon = "items/gadgets/projectile_launcher_fire.png"
GADGET.Duration = 0
GADGET.Cooldown = 10
GADGET.Active = true
GADGET.Params = {
...
GADGET.Hooks.Horde_UseActiveGadget = function (ply)
    ...
    if ply:Horde_GetGadget() ~= "gadget_projectile_launcher_fire" then return end

    local rocket = ents.Create("projectile_launcher_fire_round")
    local vel = 2000
