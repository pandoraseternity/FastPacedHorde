GADGET.PrintName = "Projectile Launcher (Ballistic)"
GADGET.Description = "Shoots a ballistic projectile.\nProjectile deals 300 Ballistic damage.\nStuns enemy on hit."
...
GADGET.Hooks.Horde_UseActiveGadget = function (ply)
    ...
    if ply:Horde_GetGadget() ~= "gadget_projectile_launcher_ballistic" then return end

    local rocket = ents.Create("projectile_launcher_ballistic_round")
    local vel = 4000
